...
function SnapshotChip({ snapshotKey, onExport }) {
  return (
    <button
      ...
      className="px-3 py-1 text-xs font-medium rounded-full
        ...
        text-blue-300 hover:bg-blue-500/20 transition"
    >
  ...
  return (
    <div className="mb-6 space-y-4">
      ...
      {/* Date Filter */}
      <div className="flex flex-wrap gap-4 items-end bg-gray-900/40 border border-gray-700 rounded-xl p-4">
        {/* From */}
  ...
  className="flex items-center gap-2 px-4 py-2 rounded-xl border
             bg-gray-800/50 border-green-600/40 hover:shadow-xl hover:shadow-green-900/40 cursor-pointer"
>
...
<div className="flex flex-wrap gap-2 ml-auto">
  ...
  {hidden.length > 0 && (
    <details className="relative"
      onClick={(e) => e.currentTarget.removeAttribute("open")}>
      <summary className="cursor-pointer text-xs text-red-400">
        +{hidden.length} more
      </summary>

      <div
  className="absolute right-0 bottom-full mb-2 w-48
